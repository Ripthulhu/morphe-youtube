...
* **Change package name:** Add incompatible apps, update all permissions and providers ([#1847](https://github.com/Ripthulhu/morphe-youtube/issues/1847)) ([ff5359a](https://github.com/Ripthulhu/morphe-youtube/commit/ff5359ac6d61b7b7274a7d7ed7c06198c1ed3b7f))
* **GmsCore support:** Use custom provider package name when `Change package name` is used ([7d0d56d](https://github.com/Ripthulhu/morphe-youtube/commit/7d0d56d0652dbfd3bb6cd5b21dc21310e2b73e68))
* **Network proxy:** Support HTTPS proxies for auxiliary requests ([#2022](https://github.com/Ripthulhu/morphe-youtube/issues/2022)) ([ee52f90](https://github.com/Ripthulhu/morphe-youtube/commit/ee52f9033687b6022f494f9afba4e0abb1bccba1))
* preserve Gradle wrapper line endings ([06d5d82](https://github.com/Ripthulhu/morphe-youtube/commit/06d5d825e4e2f53ffc76d4f09a28bbaa5b09175d))
* **Reddit - Hide communities shelf:** Communities shelf not being hidden on experimental versions ([#1828](https://github.com/Ripthulhu/morphe-youtube/issues/1828)) ([0f05846](https://github.com/Ripthulhu/morphe-youtube/commit/0f0584668a38f7ba721a2eb9c4daec9c00de8466))
* **Reddit - Hide Trending shelves:** Hide 'Trending communities' shelf in search suggestions ([#1785](https://github.com/Ripthulhu/morphe-youtube/issues/1785)) ([a9a58fb](https://github.com/Ripthulhu/morphe-youtube/commit/a9a58fb2069437dbcbe6613f740881ca21cfd45c))
* **Reddit - Hide Trending shelves:** Hide 'Trending on Reddit' shelf ([#1849](https://github.com/Ripthulhu/morphe-youtube/issues/1849)) ([5dfff49](https://github.com/Ripthulhu/morphe-youtube/commit/5dfff49c21f0aad61e997ad1ef31c65af58f85ab))
* **Reddit - Settings:** Morphe language does not change after restarting ([#1950](https://github.com/Ripthulhu/morphe-youtube/issues/1950)) ([fc41c27](https://github.com/Ripthulhu/morphe-youtube/commit/fc41c2757c1c6897e314e35de3e227adede03939))
* remove duplicate YouTube app target ([130a372](https://github.com/Ripthulhu/morphe-youtube/commit/130a372c192aeffb37c4d751651f428c4b2f2739))
* **Spoof video streams:** Change default client to 'TV' ([ce3f496](https://github.com/Ripthulhu/morphe-youtube/commit/ce3f496f9013af2d4146dc0d0f86a629d9dd7d9d))
* **Spoof video streams:** Check setting value instead of availability for JavaScript toggles ([1d92650](https://github.com/Ripthulhu/morphe-youtube/commit/1d926503bf9ef29d8e135786479ecef1de20adbc))
* **YouTube - Add to queue:** Allows tablet patches for versions 21.xx ([6ef2a3f](https://github.com/Ripthulhu/morphe-youtube/commit/6ef2a3f7aadb845b0e0ec5b839773d8e68504868))
* **YouTube - Add to queue:** Prevents the flyout video id reset blocking ([93d134f](https://github.com/Ripthulhu/morphe-youtube/commit/93d134f9df792e35f0b1e40ef933262bc40fa517))
* **YouTube - Add to queue:** Show reload options when player is minimized ([#1879](https://github.com/Ripthulhu/morphe-youtube/issues/1879)) ([95c4ecf](https://github.com/Ripthulhu/morphe-youtube/commit/95c4ecfb4525ca0964a223fdf2c0f51a9d8d6da0))
* **YouTube - Add to queue:** Support tablet form factor ([#1891](https://github.com/Ripthulhu/morphe-youtube/issues/1891)) ([f55b720](https://github.com/Ripthulhu/morphe-youtube/commit/f55b7206f78e6b5dbe063e6f9e39093929047f34))
* **YouTube - Add to queue:** Use app activity for dialog to open dialog ([f3e2b2b](https://github.com/Ripthulhu/morphe-youtube/commit/f3e2b2b3f3350ff6bea937f9eb81da10aab14c34))
* **YouTube - Bypass link redirects:** Fix potential crash and cleanup ([6a0b518](https://github.com/Ripthulhu/morphe-youtube/commit/6a0b518403228c5575f80abf1c3cf48159454563))
* **YouTube - Copy video link:** Copied video link is always shortened ([#1993](https://github.com/Ripthulhu/morphe-youtube/issues/1993)) ([ff0e8cc](https://github.com/Ripthulhu/morphe-youtube/commit/ff0e8ccb935ca3e267c625778ad93f2db213c367))
* **YouTube - Disable player popup panels:** patch doesn't work for some users ([#1821](https://github.com/Ripthulhu/morphe-youtube/issues/1821)) ([2d34625](https://github.com/Ripthulhu/morphe-youtube/commit/2d34625cb3e6635fa5381ded1e38c464b8d9e269))
* **YouTube - FlyoutUtils:** Error message when opening Shorts flyout menu ([aaf5f55](https://github.com/Ripthulhu/morphe-youtube/commit/aaf5f55a3a6d769dd850023925725481768e3a15))
* **YouTube - Hide ads:** Hide shopping links in transcripts ([#2025](https://github.com/Ripthulhu/morphe-youtube/issues/2025)) ([0cf389b](https://github.com/Ripthulhu/morphe-youtube/commit/0cf389b921c813961f8b4d3bd12636b84e3f61d1))
* **YouTube - Hide layout components:**  Match `RD` playlist URLs to improve "Hide mix playlists" filter ([#1835](https://github.com/Ripthulhu/morphe-youtube/issues/1835)) ([1172ce0](https://github.com/Ripthulhu/morphe-youtube/commit/1172ce044f14cc842eb6390d997d7793f8e2b4c3))
* **YouTube - Hide layout components:** Comment box being hidden on `20.21.37` ([7f77b20](https://github.com/Ripthulhu/morphe-youtube/commit/7f77b20404368279eb216e4911cfe27b9047655e))
* **YouTube - Miniplayer/Disable automatic reposition:** Support vertical position lock ([4adc714](https://github.com/Ripthulhu/morphe-youtube/commit/4adc71465bbee964112e45ffa93e685901fcaec5))
* **YouTube - Open system share sheet:** Support channelID & commentID fetching ([#1975](https://github.com/Ripthulhu/morphe-youtube/issues/1975)) ([34c2b58](https://github.com/Ripthulhu/morphe-youtube/commit/34c2b58eab29967b1fc784ae0c644297b850ca36))
* **YouTube - Playback speed:** Support new native playback speed menu ([#1957](https://github.com/Ripthulhu/morphe-youtube/issues/1957)) ([a4641d6](https://github.com/Ripthulhu/morphe-youtube/commit/a4641d6731170e03b26abc4ecb37230193271673))
* **YouTube - Reload video button:** Use the correct URL query parameters ([9b399ec](https://github.com/Ripthulhu/morphe-youtube/commit/9b399ec5d240f84d7a9f2d2ffc3cb7877df1d0da))
* **YouTube - Return YouTube Dislike:** Remove RYD Shorts due to YT removing Shorts dislike and RYD API no longer providing reliable Shorts dislikes data ([#1924](https://github.com/Ripthulhu/morphe-youtube/issues/1924)) ([fcb613a](https://github.com/Ripthulhu/morphe-youtube/commit/fcb613aacb28ccd319f7211282305d0c6a912874))
* **YouTube - Return YouTube Dislike:** Unnecessary RYD API requests in playlist ([#1815](https://github.com/Ripthulhu/morphe-youtube/issues/1815)) ([219114a](https://github.com/Ripthulhu/morphe-youtube/commit/219114aaa3ae0e67993457a9f706bb5f7c397257))
* **YouTube - SponsorBlock:** Resolve missing resource dependency when patch is excluded ([3721511](https://github.com/Ripthulhu/morphe-youtube/commit/3721511a7e89124fe92d529399f58f3ec39b26f3))
* **YouTube - SponsorBlock:** Send correct user agent when submitting segments ([#1903](https://github.com/Ripthulhu/morphe-youtube/issues/1903)) ([37cecf4](https://github.com/Ripthulhu/morphe-youtube/commit/37cecf4e5e87599a24178aaaa7ebcd6703591c95))
* **YouTube - Spoof video streams:** Mention Android Studio 720p limitation in settings UI ([387abbf](https://github.com/Ripthulhu/morphe-youtube/commit/387abbf4c543a4c5ed9b6574bf792e7ce3b1c949))
* **YouTube - StreamOrDetailsDataRequest:** Sometimes player headers is null ([#2035](https://github.com/Ripthulhu/morphe-youtube/issues/2035)) ([c9552c0](https://github.com/Ripthulhu/morphe-youtube/commit/c9552c0eee1415e290218cfe603bb4af98ed0681))
* **YouTube - System share sheet:** Added full link format along with shortener setting check ([0259b4c](https://github.com/Ripthulhu/morphe-youtube/commit/0259b4c50ea5502f8c7f2457a9d8522cbee4915a))
* **YouTube - System share sheet:** Prevents consecutive attempts to close the panel ([d9c6b1b](https://github.com/Ripthulhu/morphe-youtube/commit/d9c6b1b08fdc290ed5f59ad80056452ca5f0d52b))
* **YouTube - System share sheet:** Support older app versions ([d1ccae8](https://github.com/Ripthulhu/morphe-youtube/commit/d1ccae8dc396322d406134122e90fb13c6c3ae0c))
* **YouTube - System Share:** Increased the opening speed of the system share sheet ([9cacff8](https://github.com/Ripthulhu/morphe-youtube/commit/9cacff89172fb05760bdae2dbbae275c0db5934c))
* **YouTube - Video queue:** A video from a playlist does not opened or reloaded within the playlist. ([fbca3e7](https://github.com/Ripthulhu/morphe-youtube/commit/fbca3e755a67d89026064a6c04dfbaf1bb676caf))
* **YouTube - Voice over translation:** Keep the user's original audio volume ratio after rewinding ([#1939](https://github.com/Ripthulhu/morphe-youtube/issues/1939)) ([d673d91](https://github.com/Ripthulhu/morphe-youtube/commit/d673d9181d7a203824bab2a83955d965d2423c3b))
* **YouTube Music - Downloads:** Add "Override feed/search flyout button" setting ([#1931](https://github.com/Ripthulhu/morphe-youtube/issues/1931)) ([af7cf55](https://github.com/Ripthulhu/morphe-youtube/commit/af7cf55a99c9ebf8e42649af4b931bb74cedf086))
* **YouTube Music - Downloads:** Hide Premium dialog on external download ([#2009](https://github.com/Ripthulhu/morphe-youtube/issues/2009)) ([4cfe552](https://github.com/Ripthulhu/morphe-youtube/commit/4cfe552daa946c8d4ca946aeffffb63b62ad8370))
* **YouTube Music - Scrobbling:** Parse artist and track from video title ([#1885](https://github.com/Ripthulhu/morphe-youtube/issues/1885)) ([29c8d02](https://github.com/Ripthulhu/morphe-youtube/commit/29c8d021426abc5d04c9cea0ae7aa9139374b38e))
* **YouTube Music - SponsorBlock:** Support older app versions ([bb74726](https://github.com/Ripthulhu/morphe-youtube/commit/bb7472618b96cf6953292b8466c347a1ddd523df))
* **YouTube Music:** Fix 9.15.51 startup ([9e2c372](https://github.com/Ripthulhu/morphe-youtube/commit/9e2c37218aeb601d1d05d66fba4d89255d20c01f))

### ✨ New Features

* Add `Network proxy` patch ([#1823](https://github.com/Ripthulhu/morphe-youtube/issues/1823)) ([6bf4d9f](https://github.com/Ripthulhu/morphe-youtube/commit/6bf4d9f436a9056b4af7df700ef5b91499b2c1eb))
* **YouTube - Hide layout components:** Add "AI channel filter" settings ([#1972](https://github.com/Ripthulhu/morphe-youtube/issues/1972)) ([03c0b97](https://github.com/Ripthulhu/morphe-youtube/commit/03c0b97f983a3bbae22bba3a5f51bd2fc09e9a25))
* **YouTube - Hide layout components:** Add "Hide filter bar in comments" and "Sanitize highlighted search links" settings ([#1935](https://github.com/Ripthulhu/morphe-youtube/issues/1935)) ([1876708](https://github.com/Ripthulhu/morphe-youtube/commit/187670860225c5c8272a4f34d131a98448ca311c))
* **YouTube - Hide layout components:** Add "Hide gift animation and cards" and "Hide gift button" settings ([#1991](https://github.com/Ripthulhu/morphe-youtube/issues/1991)) ([83451d9](https://github.com/Ripthulhu/morphe-youtube/commit/83451d95249b4e951b466c3b7ff8a64b3d7f1a4d))
* **YouTube - Hide layout components:** Add "Hide video thumbnail" setting ([#2043](https://github.com/Ripthulhu/morphe-youtube/issues/2043)) ([360bc41](https://github.com/Ripthulhu/morphe-youtube/commit/360bc412759a8de12ecd31b30f95d199801eea0f))
* **YouTube - Hide layout components:** Add "Sanitize video subtitle" setting ([#1277](https://github.com/Ripthulhu/morphe-youtube/issues/1277)) ([0cb4bc5](https://github.com/Ripthulhu/morphe-youtube/commit/0cb4bc5d59c18b3df9037914db2002942db127be))
* **YouTube - Miniplayer:** Add "Disable automatic reposition" setting ([#1920](https://github.com/Ripthulhu/morphe-youtube/issues/1920)) ([e49c0b4](https://github.com/Ripthulhu/morphe-youtube/commit/e49c0b4053a2bcfd0f9b1140d1e5438e43d215c5))
* **YouTube - Miniplayer:** Add "Disable playback with horizontal drag" setting ([#1916](https://github.com/Ripthulhu/morphe-youtube/issues/1916)) ([186f060](https://github.com/Ripthulhu/morphe-youtube/commit/186f0603352f26e30fdfab100fe0b77eb22496d6))
* **YouTube - Swipe controls:** Add playback speed step preference ([#1977](https://github.com/Ripthulhu/morphe-youtube/issues/1977)) ([25927d1](https://github.com/Ripthulhu/morphe-youtube/commit/25927d12ec5d5a1c0bba570a70ba09fe1e28497c))
* **YouTube - Theme:** Add "Modern YouTube" dark theme preset ([#1918](https://github.com/Ripthulhu/morphe-youtube/issues/1918)) ([0a381c8](https://github.com/Ripthulhu/morphe-youtube/commit/0a381c8c0cd80d1bd3cb1f339587e48798ced00f))
* **YouTube Music - Change miniplayer color:** Add "Change navigation bar color" setting ([#1908](https://github.com/Ripthulhu/morphe-youtube/issues/1908)) ([9b570cd](https://github.com/Ripthulhu/morphe-youtube/commit/9b570cd2cfcd0695fa38ea84541133940146e7cf))
* **YouTube Music - Settings:** Add Morphe language selector ([#1937](https://github.com/Ripthulhu/morphe-youtube/issues/1937)) ([443500c](https://github.com/Ripthulhu/morphe-youtube/commit/443500c66718d722a393707712c78ac3232e0fbd))
* **YouTube Music:** Add `Disable dislike redirection` patch ([#1962](https://github.com/Ripthulhu/morphe-youtube/issues/1962)) ([e399e05](https://github.com/Ripthulhu/morphe-youtube/commit/e399e05835f40e00a5efb9f311eadbee9be599a9))
* **YouTube Music:** Add `Downloads` patch ([#1881](https://github.com/Ripthulhu/morphe-youtube/issues/1881)) ([d078a37](https://github.com/Ripthulhu/morphe-youtube/commit/d078a37cd1a8ef93f9546efb24e783a7b826a8b8))
* **YouTube Music:** Add `Hide flyout menu components` patch ([#1906](https://github.com/Ripthulhu/morphe-youtube/issues/1906)) ([dbc4ba0](https://github.com/Ripthulhu/morphe-youtube/commit/dbc4ba08c0e23838dafa17d7fd0cfc9d33ba6524))
* **YouTube Music:** Add `Hide layout components` patch with `Custom filter` ([#1919](https://github.com/Ripthulhu/morphe-youtube/issues/1919)) ([f6e9849](https://github.com/Ripthulhu/morphe-youtube/commit/f6e9849331a16eebf870338e75012a529915d3b8))
* **YouTube Music:** Add `Hide music action buttons` patch ([#1953](https://github.com/Ripthulhu/morphe-youtube/issues/1953)) ([b142f87](https://github.com/Ripthulhu/morphe-youtube/commit/b142f87e39cbe30e046d8731fa2997d6a1523bf7))
* **YouTube Music:** Add `Remember shuffle state` patch ([#1963](https://github.com/Ripthulhu/morphe-youtube/issues/1963)) ([7e8a6ba](https://github.com/Ripthulhu/morphe-youtube/commit/7e8a6babdbafd1dd87ac1397c088f318b89a02da))
* **YouTube Music:** Add `Scrobbling` patch ([#1856](https://github.com/Ripthulhu/morphe-youtube/issues/1856)) ([f9ca802](https://github.com/Ripthulhu/morphe-youtube/commit/f9ca802aa756d7eb78ab86df5f302c3abfe2d15b))
* **YouTube Music:** Add `SponsorBlock` patch ([#1842](https://github.com/Ripthulhu/morphe-youtube/issues/1842)) ([0e6e8f1](https://github.com/Ripthulhu/morphe-youtube/commit/0e6e8f1c0d53df205be8cf12f365224293128f1f))
* **YouTube Music:** Add `Spoof app version` patch ([#1948](https://github.com/Ripthulhu/morphe-youtube/issues/1948)) ([46a86d3](https://github.com/Ripthulhu/morphe-youtube/commit/46a86d3106e9e00d718e5410ef0c03fb6b228f90))
* **YouTube:** Add `Add to queue` patch ([#1837](https://github.com/Ripthulhu/morphe-youtube/issues/1837)) ([36a1e6e](https://github.com/Ripthulhu/morphe-youtube/commit/36a1e6e6d6c529aa94fc607970c2cf067b0f6f4c))
* **YouTube:** Add `Voice over translation` patch ([#1685](https://github.com/Ripthulhu/morphe-youtube/issues/1685)) ([d811a32](https://github.com/Ripthulhu/morphe-youtube/commit/d811a3264878d01697eb75bd05185d9359603a4a))

### 🚀 Updated App Support

* **Reddit:** Add experimental support for `2026.26.0` ([de01fad](https://github.com/Ripthulhu/morphe-youtube/commit/de01fadca647632390ecf4148986880d924434b5))
* **Reddit:** Add experimental support for `2026.27.0` ([4dabc41](https://github.com/Ripthulhu/morphe-youtube/commit/4dabc4142664669937d47ffad7d6f768aaa48f8e))
* **Reddit:** Add experimental support for `2026.28.0` ([9f18957](https://github.com/Ripthulhu/morphe-youtube/commit/9f18957acd350db0180cb2c66521e8b83b598558))
* **YouTube Music:** Add experimental support for `9.25.50` ([bc6d8aa](https://github.com/Ripthulhu/morphe-youtube/commit/bc6d8aa3517cfa7918d0ac5849ccff42c7340ad6))
* **YouTube Music:** Add experimental support for `9.26.51` ([0be25a1](https://github.com/Ripthulhu/morphe-youtube/commit/0be25a10bfe1afbcb8bbdc5ff25b0272ba468ab4))
* **YouTube:** Add experimental support for `21.26.360` ([197e9ce](https://github.com/Ripthulhu/morphe-youtube/commit/197e9ce272515002787a41c919ff7ea8ec698f30))
* **YouTube:** Add support for `21.04.223` ([12e19c0](https://github.com/Ripthulhu/morphe-youtube/commit/12e19c00a143c90b3dd12668a45e07b0cc6dd7a0))
